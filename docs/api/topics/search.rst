...
.. http:get:: /api/v1/apps/search/
    ...
    **Request**
    ...
    :param optional lang: Filters apps by a supported language. Language codes
        should be provied in ISO 639-1 format. Use a comma-separated list if
        supplying multiple languages.
    :type manifest_url: string
