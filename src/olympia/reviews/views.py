...
from .helpers import CanDeleteReviewPermission, user_can_delete_review
...
class ReviewViewSet(AddonChildMixin, CreateModelMixin, ListModelMixin,
    ...
    def check_permissions(self, request):
        # In addition to the regular permission checks that are made, we need
        # to verify that the add-on exists, is public and listed. Just loading
        # the addon should be enough.
