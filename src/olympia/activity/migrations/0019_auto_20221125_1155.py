...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='_arguments',
            field=models.TextField(blank=True, db_column='arguments', max_length=100000),
        ),
        migrations.AlterField(
            model_name='activitylog',
            name='_details',
            field=models.TextField(blank=True, db_column='details', max_length=100000),
        ),
        migrations.AlterField(
            model_name='activitylog',
            name='action',
        ...
        migrations.AddConstraint(
            model_name='activitylog',
            constraint=models.CheckConstraint(check=models.Q(('_arguments__length__lte', 100000)), name='activity_ac__argume_2073a2b2_mlen'),
        ),
        migrations.AddConstraint(
            model_name='activitylog',
            constraint=models.CheckConstraint(check=models.Q(('_details__length__lte', 100000)), name='activity_ac__detail_c1bf93d3_mlen'),
        ),
        migrations.AddConstraint(
            model_name='commentlog',
            constraint=models.CheckConstraint(check=models.Q(('comments__length__lte', 100000)), name='activity_co_comment_b24d12bf_mlen'),
        ),
        migrations.AddConstraint(
            model_name='draftcomment',
            constraint=models.CheckConstraint(check=models.Q(('comment__length__lte', 100000)), name='activity_dr_comment_fef6aaad_mlen'),
        ),
    ]
